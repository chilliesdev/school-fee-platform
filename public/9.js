...
function Input(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    ref: handleChange // className={error ? 'input-error' : null}
    ,
    disabled: disabled
...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])([]),
      ...
      setPaymentConst = _useState4[1]; // const [ disabledInput, setDisabledInput ] = useState(false)
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              data = response.data;
              console.log(response); // setPaymentConst(data)
            ...
            case 8:
              ...
              conole.error(_context.t0.detail);
              setTimeout(function () {
                getPaymentConstants();
              }, 3000);
  ...
  function openConfirmDialogue(data) {
    var postData = {};
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('/pay', postData);
  }

  handleSubmit(function (data) {
    return console.log(data);
  });
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_4__["Input"], {
    placeholder: "YOUR SCHOOL NAME",
    icon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_icons_fa__WEBPACK_IMPORTED_MODULE_5__["FaSearch"], null),
    size: "lg",
    name: "school",
